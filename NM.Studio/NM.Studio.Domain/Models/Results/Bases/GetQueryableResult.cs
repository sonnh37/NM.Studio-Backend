...
public class GetQueryableResult
{
    public GetQueryableResult()
    {
    }

    public GetQueryableResult(IEnumerable<object>? results = null, int? totalCount = null,
        GetQueryableQuery? query = null)
    {
        Results = results ?? [];
